...
public class Plugin : BasePlugin
{
    ...
    {
        DarkModeConfig = Config.Bind("SickoPatch",
                                     "SickoPatch",
                                     true,
    ...
    public static class ChatBubblePatch
    {
        ...
        public static void SetText_Prefix(ChatBubble __instance, ref string chatText)
        {
            ...
            else
            {
                ...
                else chatText = ColorString(Color.white, chatText.TrimEnd('\0')); //Text color
            }
        }
    }
    ...
    class ChatControllerUpdatePatch
    {
        ...
        public static void Postfix(ChatController __instance)
        {
            if (Plugin.DarkModeConfig.Value)
            {
                ...
                __instance.freeChatField.textArea.outputText.color = Color.white; // Dependency of input colored text in bg
            ...
            {
                __instance.freeChatField.textArea.outputText.color = Color.black; //input color text in bg
            }
