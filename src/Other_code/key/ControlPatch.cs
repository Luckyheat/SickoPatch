...
namespace SickoPatch
{
    ...
    class ControllerManagerUpdatePatch
    {
        public static void Postfix()
        {
            ...
            // End game [HOST | Crewmate]
            

            /*if (GetKeysDown(new[] { KeyCode.F5 }))
            {
                EndGameManager.[EMPTY CODE]();
                Log.Warning("Game is ended! [Crewmates]");
                SIGP.SIGD("<#F60><b><indent=-0.3>〖SickoPatch〗 <#F00>Game is ended!");
            }*/


            // End game [HOST | Impostor]

            /*if (GetKeysDown(new[] { KeyCode.F6 }))
            {
                EndGameManager.[EMPTY CODE]();
                Log.Warning("Game is ended! [Impostors]");
                SIGP.SIGD("<#F60><b><indent=-0.3>〖SickoPatch〗 <#F00>Game is ended!");
            }*/
            ...
            if (Input.GetKeyDown(KeyCode.F1) && GameStates.IsOnlineGame)//Fuck Hudson everywhere! [Host]
            ...
            if (Input.GetKeyDown(KeyCode.F1) && GameStates.IsFreePlay) // Fuck Hudson everywhere! [Freeplay]
            ...
            if (Input.GetKeyDown(KeyCode.F1) && GameStates.IsLocalGame) // Fuck Hudson everywhere! [logal]
